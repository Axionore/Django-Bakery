...
<template>
  <section class="mx-auto max-w-md space-y-5 py-6">
    ...
    <div
      class="rounded-md border border-amber-300 bg-amber-50 px-3 py-3 text-sm text-amber-900 dark:border-amber-900 dark:bg-amber-950 dark:text-amber-100"
    >
    ...
    <p v-else-if="codes.length === 0" class="text-sm text-slate-500 dark:text-slate-400">
